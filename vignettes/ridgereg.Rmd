...
**Attributes defined in the Class **
    ...
    Ridgereg Class contains following attributes:
      ...
      *data (data.frame). Data frame for ridgereg models
      *lamda (numeric). Numeric frame for ridgereg models
      *data_name (character). Data Frame name
      *B_ridge (vector) .Regressions coefficients

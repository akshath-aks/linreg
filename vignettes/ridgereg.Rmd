...
```
4. Using our ridgereg function to train dataset on different lambda values to fit a regression model and evaluating performance by predicting on test set.  
